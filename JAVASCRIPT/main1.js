...
function funCargarDatos(){
    ...
    //Interfaz que permite realizar peticiones HTTP a servifores web

    //OPEN -->función que solicita a un archivo JSON para obtener los datos
    peticion.open("GET","./JAVASCRIPT/datos.json");
    ...
    peticion.onload = function(){
        ...
        if(peticion.status == 200){
            ...
            document.getElementById("contenido").innerHTML = "Nombre: " +datos.nombre +" " +datos.apellido +"<br>Edad: " +datos.edad +"<br>Telefono: " +datos.telefono +"<br>Dirección: " +datos.direccion;
